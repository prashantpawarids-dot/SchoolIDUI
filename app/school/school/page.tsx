...
export default function AdminSchoolsPage() {
  ...
  // ✅ ADDED: cardTemplateFront, cardTemplateBack, principalSignature
  ...
  const loadSchools = async () => {
    try {
      ...
      const filteredSchool = data.filter((s: any) => s.schoolId === schoolId);
  ...
  const saveSchool = async () => {
    ...
    try {
      ...
      // ✅ ADDED: cardTemplateFront, cardTemplateBack, principalSignature to payload
      const payload = {
      ...
      // ✅ ADDED: reset includes new fields
      setSchoolForm({
        schoolName: "",
        schoolAddress: "",
        contactPerson: "",
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
          <Card className="w-full max-w-md shadow-xl rounded-xl overflow-hidden bg-white max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="p-6 space-y-4 text-gray-700">
              ...
              {/* ✅ ADDED: template previews in view modal */}
              ...
              {/* ✅ ADDED: principal signature in view modal */}
